import 'package:ag_crm_myadmin/views/verify_email/screens/verified_email_screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Verify your email addess", style: TextStyle(fontSize: 30)),
              SizedBox(height: 10),
              Text(
                "urazimbetovazamat6@gmail.com",
